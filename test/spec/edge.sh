...
expect_err 'SyntaxError' 'extern func'
expect_err 'SyntaxError' 'extern const a'
expect_err 'SyntaxError' 'extern const a:'
expect_err 'SyntaxError' 'extern const a: Str = '
expect_err 'SyntaxError' 'const a: Str = '
expect_err 'SyntaxError' 'func a'
expect_err 'SyntaxError' 'func a('
expect_err 'SyntaxError' 'func a(a'
expect_err 'SyntaxError' 'func a(a: '
expect_err 'SyntaxError' 'func a(a: A'
expect_err 'SyntaxError' 'func a(a: A, b'
expect_err 'SyntaxError' 'func a(a: A, b:'
expect_err 'SyntaxError' 'func a(a: A, b: a'
expect_err 'SyntaxError' 'func a(a: A) {'
expect_err 'SyntaxError' 'func a(a: A) { 1;'
expect_err 'SyntaxError' 'func a(a: A,'
expect_err 'SyntaxError' 'func a(a: A, b'
expect_err 'SyntaxError' 'func a(a: A, b:'
expect_err 'SyntaxError' 'func a(a: A, b: a'
expect_err 'SyntaxError' 'func a(a: A, b: a,'
expect_err 'SyntaxError' 'func a(a: A, b: a, c'
expect_err 'SyntaxError' 'func a(a: A, b, c'
expect_err 'SyntaxError' 'func a(a: A),'
expect_err 'SyntaxError' 'func a(,'
expect_err 'SyntaxError' 'func a(;'
...
expect_err 'SyntaxError' 'class S { func'
expect_err 'SyntaxError' 'class S { func a'
expect_err 'SyntaxError' 'class S { func a('
expect_err 'SyntaxError' 'class S { func f(self'
expect_err 'SyntaxError' 'class S { func f(self:'
expect_err 'SyntaxError' 'class S { func f(self,'
expect_err 'SyntaxError' 'class S { func a(self, a'
expect_err 'SyntaxError' 'class S { func a(self, a: '
expect_err 'SyntaxError' 'class S { func a(self, a: Str'
expect_err 'SyntaxError' 'class S { func a(self, a: Str) {'
expect_err 'SyntaxError' 'class S { func a(self, a: Str) { 1;'
expect_err 'SyntaxError' 'class S { func a(self, a: Str) { 1; }'
expect_err 'SyntaxError' 'class S { func f(self: ) {} }'
...
expect_err 'SyntaxError' 'new S { a:'
expect_err 'SyntaxError' 'new S { a:'
expect_err 'SyntaxError' 'new S { func'
expect_err 'SyntaxError' 'new S { func s'
expect_err 'SyntaxError' 'new S { s: func s() {'
