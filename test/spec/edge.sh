...
expect_err 'SyntaxError' 'extern def'
expect_err 'SyntaxError' 'extern const a'
expect_err 'SyntaxError' 'extern const a:'
expect_err 'SyntaxError' 'extern const a: Str = '
expect_err 'SyntaxError' 'const a: Str = '
expect_err 'SyntaxError' 'def a'
expect_err 'SyntaxError' 'def a('
expect_err 'SyntaxError' 'def a(a'
expect_err 'SyntaxError' 'def a(a: '
expect_err 'SyntaxError' 'def a(a: A'
expect_err 'SyntaxError' 'def a(a: A, b'
expect_err 'SyntaxError' 'def a(a: A, b:'
expect_err 'SyntaxError' 'def a(a: A, b: a'
expect_err 'SyntaxError' 'def a(a: A) {'
expect_err 'SyntaxError' 'def a(a: A) { 1;'
expect_err 'SyntaxError' 'def a(a: A,'
expect_err 'SyntaxError' 'def a(a: A, b'
expect_err 'SyntaxError' 'def a(a: A, b:'
expect_err 'SyntaxError' 'def a(a: A, b: a'
expect_err 'SyntaxError' 'def a(a: A, b: a,'
expect_err 'SyntaxError' 'def a(a: A, b: a, c'
expect_err 'SyntaxError' 'def a(a: A, b, c'
expect_err 'SyntaxError' 'def a(a: A),'
expect_err 'SyntaxError' 'def a(,'
expect_err 'SyntaxError' 'def a(;'
...
expect_err 'SyntaxError' 'class S { def'
expect_err 'SyntaxError' 'class S { def a'
expect_err 'SyntaxError' 'class S { def a('
expect_err 'SyntaxError' 'class S { def f(self'
expect_err 'SyntaxError' 'class S { def f(self:'
expect_err 'SyntaxError' 'class S { def f(self,'
expect_err 'SyntaxError' 'class S { def a(self, a'
expect_err 'SyntaxError' 'class S { def a(self, a: '
expect_err 'SyntaxError' 'class S { def a(self, a: Str'
expect_err 'SyntaxError' 'class S { def a(self, a: Str) {'
expect_err 'SyntaxError' 'class S { def a(self, a: Str) { 1;'
expect_err 'SyntaxError' 'class S { def a(self, a: Str) { 1; }'
expect_err 'SyntaxError' 'class S { def f(self: ) {} }'
...
expect_err 'SyntaxError' 'new S { a:'
expect_err 'SyntaxError' 'new S { a:'
expect_err 'SyntaxError' 'new S { def'
expect_err 'SyntaxError' 'new S { def s'
expect_err 'SyntaxError' 'new S { s: def s() {'
