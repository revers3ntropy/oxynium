...
#expect_expr_bool 'true' 'input() == "a"'      'a'
#expect_expr_bool 'true' 'input() == "abcdef"' 'abcdef'
#expect_expr_bool 'false' 'input() == "a"'     'b'
#expect_expr_bool 'false' 'input() == "abc"'   'bca'
#expect_expr_bool 'false' 'input() == "a"'     'ab'
#expect_expr_bool 'false' 'input() == "ab"'    'a'
